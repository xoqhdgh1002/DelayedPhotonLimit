...
//float time_split_by_CAT[7] = {0.5,  0.5,   1.5,   0.5,   0.5,   1.5,   1.5};
//float met_split_by_CAT[7] = {300.0, 300.0, 200.0, 300.0, 300.0, 300.0, 300.0};
...
std::cout<<"**********\nUsing input file for data: "<<inputFileName_data<<std::endl;
...
std::string cut_pho2 = " && ((abs(pho2Eta) < 1.4444 && pho2EBDNN > 0.4734) || (abs(pho2Eta) > 1.4444 && pho2EEDNN > 0.1300))";

//std::string cut_pho2 = "&& pho2SigmaIetaIeta < 0.03 && pho2HoverE < 0.1 && pho2ecalPFClusterIso < 6.0 && pho2hcalPFClusterIso < 6.0 && (pho2hcalPFClusterIso*(1.0-pho2isStandardPhoton) < 30.0) && (pho2trkSumPtHollowConeDR03 < 6.0 )&& abs(pho2Eta) <2.0 && pho2R9 > 0.8";
std::string cut_pho1 = " && pho1Pt > 70  && pho1R9 > 0.9 && abs(pho1Eta)<1.4442 && pho1DNN > 0.1272 && pho1passTrackVeto && abs(pho1HoverE) <= 0.15 && pho1R9 >= 0.9 && abs(pho1SigmaIetaIeta) < 0.014 && abs(pho1ecalPFClusterIso) < (5+0.01*pho1Pt) && abs(pho1hcalPFClusterIso) < (12.5+0.03*pho1Pt+3.0e-5*pho1Pt*pho1Pt) && abs(pho1trkSumPtHollowConeDR03) < (6+2.0e-3*pho1Pt)";
std::string cut_pho1_scaleUp = " && pho1Pt_scaleUp > 70 && pho1R9 > 0.9 && abs(pho1Eta)<1.4442 && pho1DNN > 0.1272 && pho1passTrackVeto && abs(pho1HoverE) <= 0.15 && pho1R9 >= 0.9 && abs(pho1SigmaIetaIeta) < 0.014 && abs(pho1ecalPFClusterIso) < (5+0.01*pho1Pt) && abs(pho1hcalPFClusterIso) < (12.5+0.03*pho1Pt+3.0e-5*pho1Pt*pho1Pt) && abs(pho1trkSumPtHollowConeDR03) < (6+2.0e-3*pho1Pt)";
std::string cut_pho1_scaleDown = " && pho1Pt_scaleDown > 70 && pho1R9 > 0.9&& abs(pho1Eta)<1.4442 && pho1DNN > 0.1272 && pho1passTrackVeto && abs(pho1HoverE) <= 0.15 && pho1R9 >= 0.9 && abs(pho1SigmaIetaIeta) < 0.014 && abs(pho1ecalPFClusterIso) < (5+0.01*pho1Pt) && abs(pho1hcalPFClusterIso) < (12.5+0.03*pho1Pt+3.0e-5*pho1Pt*pho1Pt) && abs(pho1trkSumPtHollowConeDR03) < (6+2.0e-3*pho1Pt)";
std::string cut_pho1_smearUp = " && pho1Pt_smearUp > 70 && pho1R9 > 0.9&& abs(pho1Eta)<1.4442 && pho1DNN > 0.1272 && pho1passTrackVeto && abs(pho1HoverE) <= 0.15 && pho1R9 >= 0.9 && abs(pho1SigmaIetaIeta) < 0.014 && abs(pho1ecalPFClusterIso) < (5+0.01*pho1Pt) && abs(pho1hcalPFClusterIso) < (12.5+0.03*pho1Pt+3.0e-5*pho1Pt*pho1Pt) && abs(pho1trkSumPtHollowConeDR03) < (6+2.0e-3*pho1Pt)";
std::string cut_pho1_smearDown = " && pho1Pt_smearDown > 70 && pho1R9 > 0.9 && abs(pho1Eta)<1.4442 && pho1DNN > 0.1272 && pho1passTrackVeto && abs(pho1HoverE) <= 0.15 && pho1R9 >= 0.9 && abs(pho1SigmaIetaIeta) < 0.014 && abs(pho1ecalPFClusterIso) < (5+0.01*pho1Pt) && abs(pho1hcalPFClusterIso) < (12.5+0.03*pho1Pt+3.0e-5*pho1Pt*pho1Pt) && abs(pho1trkSumPtHollowConeDR03) < (6+2.0e-3*pho1Pt)";


std::string event_cut = " && n_Jets > 2 &&  (HT > 400) ";

if (category == "3J") 
{
	if(!useBDT)
	{
		cut = "n_Jets > 2 &&  n_Photons > 1 && HLTDecision[880] == 1 && HT > 400  " + cut_MET_filter + cut_pho1 + cut_pho2;
		cut_JESUp = "n_Jets_JESUp > 2 &&  n_Photons > 1  && HLTDecision[880] == 1 && HT > 400  " + cut_MET_filter + cut_pho1 + cut_pho2;
		cut_JESDown = "n_Jets_JESDown > 2 &&  n_Photons > 1 &&HLTDecision[880] == 1 && HT > 400   " + cut_MET_filter + cut_pho1 + cut_pho2;
		cut_phoScaleUp = "n_Jets > 2 &&  n_Photons > 1 && HLTDecision[880] == 1 && HT > 400   " + cut_MET_filter + cut_pho1_scaleUp + cut_pho2;
		cut_phoScaleDown = "n_Jets > 2 &&  n_Photons > 1 && HLTDecision[880] == 1 && HT > 400   " + cut_MET_filter + cut_pho1_scaleDown + cut_pho2;
		cut_phoSmearUp = "n_Jets > 2 &&  n_Photons > 1 && HLTDecision[880] == 1 && HT > 400   " + cut_MET_filter + cut_pho1_smearUp + cut_pho2;
		cut_phoSmearDown = "n_Jets > 2 &&  n_Photons > 1 && HLTDecision[880] == 1 && HT > 400   " + cut_MET_filter + cut_pho1_smearDown + cut_pho2;
	}
	else
	{
		cut = "pho1Pt > 70 && abs(pho1Eta)<1.4442 && disc > 0.10 && pho1passTrackVeto && n_Jets > 2 &&  n_Photons > 1 && HT > 400   " + cut_MET_filter;
		cut_JESUp = "pho1Pt > 70 && abs(pho1Eta)<1.4442 && disc > 0.10 && pho1passTrackVeto && n_Jets_JESUp > 2 &&  n_Photons > 1 && HT > 400   " + cut_MET_filter;
		cut_JESDown = "pho1Pt > 70 && abs(pho1Eta)<1.4442 && disc > 0.10 && pho1passTrackVeto && n_Jets_JESDown > 2 &&  n_Photons > 1 && HT > 400   " + cut_MET_filter;
		cut_phoScaleUp = "pho1Pt_scaleUp > 70 && abs(pho1Eta)<1.4442 && disc > 0.10 && pho1passTrackVeto && n_Jets > 2 &&  n_Photons > 1 && HT > 400   " + cut_MET_filter;
		cut_phoScaleDown = "pho1Pt_scaleDown > 70 && abs(pho1Eta)<1.4442 && disc > 0.10 && pho1passTrackVeto && n_Jets > 2 &&  n_Photons > 1 && HT > 400   " + cut_MET_filter;
		cut_phoSmearUp = "pho1Pt_smearUp > 70 && abs(pho1Eta)<1.4442 && disc > 0.10 && pho1passTrackVeto && n_Jets > 2 &&  n_Photons > 1 && HT > 400   " + cut_MET_filter;
		cut_phoSmearDown = "pho1Pt_smearDown > 70 && abs(pho1Eta)<1.4442 && disc > 0.10 && pho1passTrackVeto && n_Jets > 2 &&  n_Photons > 1 && HT > 400   " + cut_MET_filter;
	}
}

else if (category == "3J1P")
{
	if(!useBDT)
	{
		cut = " n_Jets > 2 &&  n_Photons == 1 && HLTDecision[880] == 1 && HT > 400 " + cut_MET_filter + cut_pho1;
		cut_JESUp = "n_Jets_JESUp > 2 &&  n_Photons == 1 && HLTDecision[880] == 1 && HT > 400   " + cut_MET_filter + cut_pho1;
		cut_JESDown = "n_Jets_JESDown > 2 &&  n_Photons == 1 && HLTDecision[880] == 1 && HT > 400   " + cut_MET_filter + cut_pho1;
		cut_phoScaleUp = "n_Jets > 2 &&  n_Photons == 1 && HLTDecision[880] == 1 && HT > 400   " + cut_MET_filter + cut_pho1_scaleUp;
		cut_phoScaleDown = "n_Jets > 2 &&  n_Photons == 1 && HLTDecision[880] == 1 && HT > 400   " + cut_MET_filter + cut_pho1_scaleDown;
		cut_phoSmearUp = "n_Jets > 2 &&  n_Photons == 1 && HLTDecision[880] == 1 && HT > 400   " + cut_MET_filter + cut_pho1_smearUp;
		cut_phoSmearDown = "n_Jets > 2 &&  n_Photons == 1 && HLTDecision[880] == 1 && HT > 400 " + cut_MET_filter + cut_pho1_smearDown;
	}
	else
	{
		cut = "pho1Pt > 70 && abs(pho1Eta)<1.4442 && disc > 0.10 && pho1passTrackVeto && n_Jets > 2 &&  n_Photons == 1 && HT > 400   " + cut_MET_filter;
...
{
	std::cerr << "[ERROR]: please provide a valid category: 3J or 3J1P" << std::endl;
	return -1;
}
...
//if(category == "3J1P" && useBDT ) outPlotsDir = "plots_3J1P_withBDT";
if(category == "3J1P" && !useBDT ) outPlotsDir = "plots_3J1P_noBDT";
...
//if(category == "3J1P" && useBDT) outBinningDir = "binning_3J1P_withBDT";
if(category == "3J1P" && !useBDT) outBinningDir = "binning_3J1P_noBDT";
...
if(category == "3J1P" && useBDT) outDataCardsDir = "datacards_3J1P_withBDT";
if(category == "3J1P" && !useBDT) outDataCardsDir = "datacards_3J1P_noBDT";
...
if(category == "3J1P" && useBDT) outBiasDir = "bias_3J1P_withBDT";
if(category == "3J1P" && !useBDT) outBiasDir = "bias_3J1P_noBDT";
...
mkdir("fit_results/2018D", S_IRWXU | S_IRWXG | S_IRWXO);
mkdir("fit_results/2018D/datacards_temp", S_IRWXU | S_IRWXG | S_IRWXO);
if (category == "3J")
{
    mkdir("fit_results/2018D/plots_3J_noBDT", S_IRWXU | S_IRWXG | S_IRWXO);
    mkdir("fit_results/2018D/datacards_3J_noBDT", S_IRWXU | S_IRWXG | S_IRWXO);
    mkdir("fit_results/2018D/binning_3J_noBDT", S_IRWXU | S_IRWXG | S_IRWXO);
}
else if (category == "3J1P")
{
    mkdir("fit_results/2018D/plots_3J1P_noBDT", S_IRWXU | S_IRWXG | S_IRWXO);
    mkdir("fit_results/2018D/datacards_3J1P_noBDT", S_IRWXU | S_IRWXG | S_IRWXO);
    mkdir("fit_results/2018D/binning_3J1P_noBDT", S_IRWXU | S_IRWXG | S_IRWXO);
}
...
if(fitMode == "scaleSys")
{
	...
	FILE * m_outfile = fopen(("fit_results/2018D/"+_outDataCardsDir+"/scaleSys_"+sigModelName+".txt").c_str(), "w");
...
std::cout << "data file read successfully" << endl;
...
//	h2finebinMCBkg->Scale(h2finebinData->Integral()/h2finebinMCBkg->Integral());	
	...
	for(int i=0;i<timeBin.size();i++)
	{
		...
		myfile<<Time_finebins[timeBin[i]]<<"  ,  ";
...
if(fitMode == "datacard")
{
    std::cout << "Start making datacard\n"; 
...
//draw 2D binning
std::cout << "Start drawing 2D binning\n"; 
...
MakeDataCardABCD(h2_rate_Data_inBins,h2_rate_Sig_inBins, h2_rate_Data_inBins, h1_rate_Data_Time_inBins, h1_rate_Data_MET_inBins, Nbins_time, Nbins_MET, _sigModelName, outDataCardsDir);
//MakeDataCardABCD(h2_dummy, h2_dummy,Nbins_time, Nbins_MET, _sigModelName, outDataCardsDir);

std::cout << "Adding systematics\n"; 
//add systematics
...
for(int iT=1; iT<=Nbins_time; iT++)
{
        for(int iM=1; iM<=Nbins_MET; iM++)
        {
                ...
                h2_TimeScale_sys_Sig_inBins->SetBinContent(iT, iM, 1.01);
...
if (sigModelName.find("Ctau0_001cm") != std::string::npos || 
        sigModelName.find("Ctau0_1cm") != std::string::npos || 
        sigModelName.find("Ctau1cm") != std::string::npos ||
        sigModelName.find("Ctau10cm") != std::string::npos)

        h2_TimeMETCorrelation_sys_Sig_inBins->SetBinContent(2, 2, 1.035);
        
else 
        h2_TimeMETCorrelation_sys_Sig_inBins->SetBinContent(2, 2, 1.90);


AddSystematics_Norm_ABCD(h2_lumi_sys_Sig_inBins, Nbins_time, Nbins_MET, "CMSLumi_2018", "lnN", _sigModelName, outDataCardsDir, true);
...
AddSystematics_Norm_ABCD(h2_JetESmear_sys_Sig_inBins, Nbins_time, Nbins_MET, "JetEResolution_2018", "lnN", _sigModelName, outDataCardsDir, true);
...
//TFile *f_Out = new TFile(("fit_results/2017ABCD/"+_outPlotsDir+"/fit_ws_"+sigModelName+".root").c_str(),"recreate");
