...
gStyle.SetOptStat(0)
outputDir = '/storage/user/qnguyen/DelayedPhoton/CMSSW_8_1_0/src/HiggsAnalysis/DelayedPhotonLimit/2018/TimingReconstruction/'
...
cut = "ele1IsEB && ele1seedE/ele1subseedE < 1.2 && ele1seedE/ele1subseedE > 0.8"

file_data = TFile("/mnt/hadoop//store/group/phys_susy/razor/Run2Analysis/EcalTiming/2021May3/hadd/EGamma_Run2018D.root")
tree_data = file_data.Get("ZeeTiming")

file_MC = TFile("/mnt/hadoop//store/group/phys_susy/razor/Run2Analysis/EcalTiming/2021May3/hadd/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8.root")
...
for i in range(0, N_Eeff_points):
	...
	cut_2e_this = cut+" && ele1subseedE > 1 && ele1seedE < 120 && ele1subseedE<120 && (ele1seedE/seed1_pedestalGeV)*(ele1subseedE/subseed1_pedestalGeV)/sqrt((ele1seedE/seed1_pedestalGeV)*(ele1seedE/seed1_pedestalGeV)+(ele1subseedE/subseed1_pedestalGeV)*(ele1subseedE/subseed1_pedestalGeV)) > "+str(Eeff_low_this)+" && (ele1seedE/seed1_pedestalGeV)*(ele1subseedE/subseed1_pedestalGeV)/sqrt((ele1seedE/seed1_pedestalGeV)*(ele1seedE/seed1_pedestalGeV)+(ele1subseedE/subseed1_pedestalGeV)*(ele1subseedE/subseed1_pedestalGeV)) < "+str(Eeff_high_this)
#	cut_2e_this = cut+" && abs(ele1Rechit_Eta) < 1.444 && ele1subseedE > 1.0 && ele1seedE < 120 && ele1subseedE<120 && (ele1seedE/seed1_pedestal)*(ele1subseedE/subseed1_pedestal)/sqrt((ele1seedE/seed1_pedestal)*(ele1seedE/seed1_pedestal)+(ele1subseedE/subseed1_pedestal)*(ele1subseedE/subseed1_pedestal)) > "+str(Eeff_low_this)+" && (ele1seedE/seed1_pedestal)*(ele1subseedE/subseed1_pedestal)/sqrt((ele1seedE/seed1_pedestal)*(ele1seedE/seed1_pedestal)+(ele1subseedE/subseed1_pedestal)*(ele1subseedE/subseed1_pedestal)) < "+str(Eeff_high_this)
	#cut_2e_this_MC = cut+" && ele1subseedE > 1 && ele1seedE < 120 && 25.31*(ele1seedE/seed1_pedestal)*(ele1subseedE/subseed1_pedestal)/sqrt((ele1seedE/seed1_pedestal)*(ele1seedE/seed1_pedestal)+(ele1subseedE/subseed1_pedestal)*(ele1subseedE/subseed1_pedestal)) > "+str(Eeff_low_this)+" && 25.31*(ele1seedE/seed1_pedestal)*(ele1subseedE/subseed1_pedestal)/sqrt((ele1seedE/seed1_pedestal)*(ele1seedE/seed1_pedestal)+(ele1subseedE/subseed1_pedestal)*(ele1subseedE/subseed1_pedestal)) < "+str(Eeff_high_this)
	cut_2e_this_MC = cut+" && abs(ele1Rechit_Eta) < 1.444 && ele1subseedE > 1.0 && ele1seedE < 120 && (ele1seedE/(seed1_pedestalGeV))*(ele1subseedE/(subseed1_pedestalGeV))/sqrt((ele1seedE/(seed1_pedestalGeV))*(ele1seedE/(seed1_pedestalGeV))+(ele1subseedE/(subseed1_pedestalGeV))*(ele1subseedE/(subseed1_pedestalGeV))) > "+str(Eeff_low_this)+" && (ele1seedE/(seed1_pedestalGeV))*(ele1subseedE/(subseed1_pedestalGeV))/sqrt((ele1seedE/(seed1_pedestalGeV))*(ele1seedE/(seed1_pedestalGeV))+(ele1subseedE/(subseed1_pedestalGeV))*(ele1subseedE/(subseed1_pedestalGeV))) < "+str(Eeff_high_this)

	hist_2e_this_data = TH1F("hist_2e_this_data_"+str(i),"hist_2e_this_data_"+str(i), 60, -1.5, 1.5)
	tree_data.Draw("t1_seed-t1_subseed>>hist_2e_this_data_"+str(i), cut_2e_this)
	hist_2e_this_data.Draw()
	result_2e_this_data = singGausFit(hist_2e_this_data)#, -1.5, 1.5, 0.2, 0.4) 
	myC.SaveAs(outputDir+"/ZeeTiming/iEeffFit_neighboring_xtal_"+str(i)+"_dt_data.png")
	...
	tree_MC.Draw("t1_seed-t1_subseed>>hist_2e_this_MC_"+str(i),  "(weight*pileupWeight) * " + cut_2e_this_MC)
	hist_2e_this_MC.Draw()
	result_2e_this_MC = singGausFit(hist_2e_this_MC)#, -1.0, 1.0, 0.15, 0.30) 
	myC.SaveAs(outputDir+"/ZeeTiming/iEeffFit_neighboring_xtal_"+str(i)+"_dt_MC.png")
...
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_2018.pdf")
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_2018.png")
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_2018.C")
...
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_corr_2018.pdf")
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_corr_2018.png")
myC.SaveAs(outputDir+"/ZeeTiming/TimingReso_neighboring_xtals_dt_vs_Eeff_sigma_Data_vs_MC_corr_2018.C")
